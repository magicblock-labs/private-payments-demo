...
export default function MissingAddressCard() {
  return (
    <Card className='h-full bg-white/80 dark:bg-card/80 backdrop-blur-sm border-border/50 border-dashed'>
      <CardHeader className='bg-linear-to-r from-gray-50 to-slate-50 dark:from-gray-950/20 dark:to-slate-950/20 border-b border-border/50 border-dashed'>
      ...
      <CardContent className='flex flex-col gap-6 items-center justify-center py-12 px-6 text-center'>
        <div className='mx-auto w-16 h-16 bg-linear-to-br from-gray-100 to-slate-100 dark:from-gray-900/20 dark:to-slate-900/20 rounded-full flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-700'>
