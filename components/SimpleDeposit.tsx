...
export default function SimpleDeposit() {
  ...
  return (
    <Card className='gap-3 overflow-hidden bg-white/80 dark:bg-card/80 backdrop-blur-sm border-border/50 shadow-xl p-0!'>
      <CardHeader className='p-2! bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 border-b border-border/50'>
        ...
        {!authToken && (
          <div className='text-center py-6'>
            <div className='space-y-4'>
              <div className='mx-auto w-16 h-16 bg-linear-to-br from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-full flex items-center justify-center mb-4'>
              ...
              <Button
                className='bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 border-0 text-white font-medium px-8 py-3 h-auto rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:scale-100'
                onClick={getToken}
