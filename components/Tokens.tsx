...
const Tokens: React.FC<{ deposit?: boolean }> = ({ deposit = false }) => {
    ...
    return (
      <>
        ...
        <Button
          ...
          disabled={isCreating}
          className='w-full md:w-auto bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 border-0 text-white font-medium px-8 py-2 h-auto rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:scale-100'
        >
          {isCreating ? (
            <>
  ...
  return (
    <Card className='gap-3 overflow-hidden bg-white/80 dark:bg-card/80 backdrop-blur-sm border-border/50 shadow-xl p-0!'>
      <CardHeader className='p-2! bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-b border-border/50'>
