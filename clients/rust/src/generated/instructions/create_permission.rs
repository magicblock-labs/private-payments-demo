...
pub struct CreatePermission {
    /// The address of the new permission
    pub permission: solana_program::pubkey::Pubkey,
    /// The address of the delegatable account
    pub delegated_account: solana_program::pubkey::Pubkey,
    /// The address of the group who has the permission
    pub group: solana_program::pubkey::Pubkey,
    /// The PDA owning the delegatable account
